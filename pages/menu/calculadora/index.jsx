...
export default function Calculadora() {
  ...
  const calculateDose = () => {
    setDose(
      ((infusionRate * (medicationConcentration * medicationVolume)) /
        solutionVolume /
        60 /
        patientWeight) *
        1000
  ...
  return (
    <div>
      ...
      <nav className={styles.navegacao}>
        <Link className={styles.navegacaolink} href="/">
          MenuPrincipal
        </Link>
      </nav>
      ...
      <div className={styles.container}>
        ...
        <label className={styles.resultado}>
          Dose: {parseFloat(dose).toFixed(2)} mcg/kg/min
        </label>

        <div className={styles.linkexterno}>
          <a
            target="_blank"
            href="https://www.mediafire.com/file/nls50ko0bqdtsvq/Planilha_de_dilui%25C3%25A7%25C3%25A3o.xlsx/file"
            rel="noreferrer noopener"
          >
            Planilha com diversas drogas
          </a>
        </div>
      </div>
    </div>
